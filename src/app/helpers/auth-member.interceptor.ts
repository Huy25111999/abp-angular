...
export class AuthMemberInterceptor implements HttpInterceptor {
  authreq;
  refresh = false;
  constructor(
  ...
  intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    const token = this.authService.getTokenMember();
          ...
          if (this.refreshTokenInProgress) {
            ...
            return autherService.refreshToken().pipe(
              ...
              switchMap((newToken: any) => {
                ...
                this.authService.saveTokenMember(JSON.stringify(newToken));

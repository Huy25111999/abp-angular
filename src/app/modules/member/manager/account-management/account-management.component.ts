...
import { CreateUpdateAccountComponent } from './create-update-account/create-update-account.component';
...
export class AccountManagementComponent implements OnInit {
  ...
  openModalCreateUpdateRole(id?: number) {
    const title = id ? 'Update account' : 'Create account';
    const dialogData = {
      title: title,
      id: id,
    };
    const modalRef = this.modalService.open(CreateUpdateAccountComponent, {
      size: 'lg',
      scrollable: true,
      centered: true,
      backdrop: 'static',
